...
function LeadModalHeader({ isReadOnly, isEditMode, isAdmin, onEditTrigger, onDeleteTrigger, onClose }: LeadModalHeaderProps) {
  return (
    <div className="p-6 border-b border-border-muted flex items-center justify-between shrink-0">
      ...
      <div className="flex items-center gap-1.5">
        {isEditMode && (
          <>
            {/* 🔒 Show trash icon ONLY if user is an admin */}
            {isAdmin && (
              <button 
